   ...
   <div class="container-fluid bg-light p-5">
    <div class="row">
        ...
        <div class="col-md-6 text-center">
            <h2 class="text-primary my-4">ADD IDEAS</h2>
            ...
            <div class="singlefield mt-2 text-start">
                <button type="button" onclick="window.location.href = 'idea.php';" class="btn btn-danger">BACK</button>
                    <button type="button" onclick="window.location.href = ' ';" class="btn btn-primary ">SUBMIT</button>
                </div>
        </div>
